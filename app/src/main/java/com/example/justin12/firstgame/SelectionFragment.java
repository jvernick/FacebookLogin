...
public class SelectionFragment extends Fragment implements View.OnClickListener {
    ...
    private InviteApplication inviteApp;
...
// Set the list view adapter
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.newGameButton:
                ...
                intent.setClassName("com.example.justin12.firstgame", "com.example.justin12.firstgame.NewGameActivity");
    ...
    public void onCreate(Bundle savedInstanceState) {
        setRetainInstance(true); // I added this
    ...
    private class PeopleListElement extends BaseListElement {
        ...
        protected void onActivityResult(Intent data) {
            selectedUsers = ((InviteApplication) getActivity()
                    .getApplication())
                    .getSelectedUsers();
            setUsersText();
            notifyDataChanged();
